    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 wow fadeInDown">
                <header>
                    <h1 class="robotoblack">¿Quienes Somos?</h1>
                    <br>
                   
                      <div style="color:#fff;background-color: darkgreen" class="panel panel-info">           
                        <div class="panel-body">
                        <p align="justify">Somos una empresa agropecuaria  fundada en el año 2015, con la finalidad de producir masivamente ganado bovino y vacuno, generando empleos y apoyando al país en una de sus necesidades básicas y de crecimiento. Con una mentalidad de no desperdicio, obtiene  el mayor rendimiento de los recursos disponibles y de apoyo al sector agropecuario de la economía venezolana, lo que es la base y soporte del país.</p>
                        </div>           
                        </div>
...
<div class="row col-md-10 col-md-offset-1">
            <div class="panel-body">
                <p align="justify"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione distinctio blanditiis cum earum quos, saepe quia, dolor reprehenderit voluptates repellat voluptatem aperiam amet obcaecati cumque veniam neque itaque error, commodi! </p>
            </div>           
</div>
</div>
</section>